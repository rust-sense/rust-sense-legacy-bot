...
class DiscordBot extends Discord.Client {
  ...
  readGeneralSettingsTemplate() {
    return JSON.parse(Fs.readFileSync(Path.join(__dirname, '..', 'templates/generalSettingsTemplate.json'), 'utf8'));
  }
  ...
  async interactionReply(interaction, content) {
    try {
      ...
      this.log(this.intlGet(null, 'errorCap'), this.intlGet(null, 'interactionReplyFailed', { error: e }), 'error');
    }
  ...
  async interactionEditReply(interaction, content) {
    try {
      ...
      this.log(this.intlGet(null, 'errorCap'), this.intlGet(null, 'interactionEditReplyFailed', { error: e }), 'error');
    }
  ...
  async interactionUpdate(interaction, content) {
    try {
      ...
      this.log(this.intlGet(null, 'errorCap'), this.intlGet(null, 'interactionUpdateFailed', { error: e }), 'error');
    }
